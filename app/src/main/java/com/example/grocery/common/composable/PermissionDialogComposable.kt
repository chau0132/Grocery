package com.example.grocery.common.composable
...
import com.example.grocery.common.ext.alertDialog
import com.example.grocery.common.ext.textButton
import com.example.grocery.theme.BrightOrange

@Composable
fun PermissionDialog(@StringRes text: Int, onRequestPermission: () -> Unit) {
